...
return [
    ...
    */
    ...
    // 'maternity' => [
    //     'maternity' => 'Maternity',
    //     'new_maternity_patient' => 'New Maternity Patient',
    //     'maternity_patients' => 'Maternity Patients',
    //     'upcoming_maternity' => 'Upcoming Maternity',
    //     'maternity_today' => 'Maternity Today',
    //     'old_maternity' => 'Old Maternity',
    // ],
    ...
    'advanced_payments' => 'Deposits',
    'patient_admissions' => 'Patient Admissions',
    'company_admissions' => 'Company',
    ...
    'pathologies' => 'Laboratory Investigations',
    'pathology_categories' => 'Laboratory Category',
    'radiology_tests' => 'Radiology Test Requests',
    'radiology_test_templates' => 'Radiology Test Templates',
    'doctor_opd_charges' => 'Doctor OPD Charges',
    'pathology_tests' => 'Laboratory Tests',
    'pathology_tests_requests' => 'Laboratory Tests Requests',
    'pathology_tests_templates' => 'Laboratory Tests Templates',
    'dynamic_pathology_templates' => 'Dynamic Pathology Templates',
    'dynamic_radiology_templates' => 'Dynamic Radiology Templates',
    'expenses' => 'Expenses',
    'income' => 'Income',
    'finance' => 'Finances',
    ...
    'select_transfer_from' => 'Select Transfer From',
    'select_transfer_to' => 'Select Transfer To',
    ...
    'adv_payments' => 'Deposits',
    'docs' => 'Docs',
    'consultation_charge' => 'Consultation Charge',
    'select_consultation_charge' => 'Select Consultation Charge',
    'vitals' => 'Vitals',
    'antenatal' => 'Antenatal',
    ...
    'user' => [
        ...
        'guardian_relation_placeholder' => 'Relationship with patient',
        'personal_information' => 'Personal Information',
        'other_details' => 'Other Patient Information',
    ...
    'roster' => [
        ...
        'end_date' => 'End Date',
        'select_roster' => 'Select Roster',
        'edit_roster' => 'Edit Roster',
    ],

    'assign_roster' => [
        'title' => 'Assign Roster',
        'new_assign_roster' => 'New Duty Roster',
        'shift_name' => 'Shift Name',
        ...
        'roster_dates' => 'Roster (Start Date - End Date)',
        'edit_assign_roster' => 'Edit Assigned Roster',
        'updated_successfully' => 'Assigned roster updated successfully!',
    ],
    ...
    'employee_payroll' => [
        ...
        'employee_payrolls' => 'Payrolls',
        'employee_payroll_details' => 'Payroll Details',
        'new_employee_payroll' => 'New Payroll',
        'edit_employee_payroll' => 'Edit Payroll',
        'sr_no' => 'Sr No',
    ...
    'supplier' => [
        ...
        'select_one_supplier' => 'Please select at least one supplier',
        'supplier_name_already_taken' => 'The supplier name has already been taken',
    ...
    'advanced_payment' => [
        'advanced_payment' => 'Deposit',
        'advanced_payments' => 'Deposit',
        'advanced_payment_details' => 'Deposit Details',
        'new_advanced_payment' => 'New Deposit',
        'edit_advanced_payment' => 'Edit Deposit',
        'patient' => 'Patient',
    ...
    'bed' => [
        ...
        'add' => 'Add',
        'bed_id' => 'Bed ID',
        'select_bed_type' => 'Select Ward Type',
    ],
    ...
    'bed_type' => [
        'bed_type' => 'Ward Type',
        'bed_types' => 'Ward Types',
        'bed_type_details' => 'Ward Type Details',
        'new_bed_type' => 'New Ward Type',
        'edit_bed_type' => 'Edit Ward Type',
        'title' => 'Title',
        'description' => 'Description',
    ],
    ...
    'medicine' => [
        ...
        'expiry_medicine_report' => 'Expiry Medicine Report',
        'medicine_transfer_report' => 'Medicine Transfer Report',
        'medicine_adjustment_report' => 'Medicine Adjustment Report',
    ...
    'dashboard' => [
        ...
        'total_advance_payments' => 'Deposit Amount',
        'notice_boards' => 'Notice Boards',
        'title' => 'Title',
        'doctors' => 'Doctors',
    ...
    'charge_type' => [
        ...
        'charge_type_details' => 'Charge Type Details',
    ...
    // laboratory keys
    'pathology_category' => [
        'pathology_categories' => 'Laboratory Categories',
        'new_pathology_category' => 'New Laboratory Category',
        'edit_pathology_category' => 'Edit Laboratory Category',
        'name' => 'Name',
        'select_charge_category' => 'Select Charge Category',
    ],
    ...
    'radiology_test' => [
        ...
        'code' => 'Code',
        'standard_charge' => 'Standard Charge',
        'previous_value' => 'PREVIOUS REPORT VALUE',
        'radiology_tests' => 'Radiology Test',
        'new_radiology_test' => 'New Bill',
        'request_radiology_test' => 'Request Radiology Test',
        'new_radiology_test_template' => 'New Radiology Test Template',
        'edit_radiology_test' => 'Edit Radiology Test',
        'radiology_test_details' => 'Radiology Test Details',
        'test_name' => 'Test Name',
        'short_name' => 'Short Name',
        ...
        'patient_name' => 'PATIENT NAME',
        'reference_name' => 'DOCTOR NAME',
        'referral_doctor' => 'REFERRAL DOCTOR',
        'previous_value' => 'PREVIOUS REPORT VALUE',
        'discount' => 'DISCOUNT (GHS)',
        'discount_percent' => 'DISCOUNT (%)',
        'total_amount' => 'AMOUNT (GHS)',
        'amount' => 'AMOUNT (GHS)',
        'amount_paid' => 'AMOUNT PAID (GHS)',
        'balance' => 'BALANCE (GHS)',
        'new_bill' => 'New Radiology Bill',
        'status' => 'Status',
        'note' => 'NOTE',
        'previous_report_value' => 'PREVIOUS REPORT VALUE',
        'ipd' => 'IPD',
        'opd' => 'OPD',
        'doctor' => 'DOCTOR',
        'total' => 'TOTAL',
        ...
        'radiology_test_details' => 'Radiology Test Details',
        'radiology_test_collection' => 'Radiology Test Collection',
    ...
    //doctor maternity charge keys
    'doctor_maternity_charge' => [
        'doctor_maternity_charge' => 'Doctor Maternity Charge',
        'new_doctor_maternity_charge' => 'New Doctor Maternity Charge',
        'edit_doctor_maternity_charge' => 'Edit Doctor Maternity Charge',
        'doctor_name' => 'Doctor Name',
        'standard_charge' => 'Standard Charge',
        'doctor' => 'Doctor',
    ],

    // laboratory test keys
    'pathology_test' => [
        'pathology_tests' => 'Laboratory Test',
        'new_pathology_test' => 'New Bill',
        'request_pathology_test' => 'Request Laboratory Test',
        'new_pathology_test_template' => 'New Laboratory Test Template',
        'edit_pathology_test' => 'Edit Laboratory Test',
        'pathology_test_details' => 'Laboratory Test Details',
        'pathology_test_collection' => 'Laboratory Test Collection',
        'test_name' => 'Test Name',
        'select_test_name' => 'Select Test Name',
        'short_name' => 'Short Name',
        'test_type' => 'Test Type',
    ...
    'diagnosis_category' => [
        ...
        'description' => 'Description',
        'icd-10-code' => 'Diagnosis ICD 10 code',
        'icd' => 'ICD 10',
        'new_icd' => 'New ICD 10',
        'upload_in_bulk' => 'Upload in Bulk',
        'category_name' => 'Category name',
    ...
    'item' => [
        ...
        'unit' => 'Unit',
        'description' => 'Description',
        'available_quantity' => 'Dispensary QTY',
    ...
    'item_stock' => [
        ...
        'item_stock_saved_successfully' => 'Item Stock saved successfully.',
        'item_stock_updated_successfully' => 'Item Stock updated successfully.',
        'item_stock_cant_deleted' => 'Item Stock can\'t be deleted.',
        'item_stock_deleted_successfully' => 'Item Stock deleted successfully.',
    ...
    'ipd_patient' => [
        ...
        'maternity_details' => 'Maternity Patient Details',
        'patient_id' => 'Patient',
        'ipd_number' => 'IPD No',
        'height' => 'Height',
        'weight' => 'Weight',
        ...
        'admission_date' => 'Admission Date',
        'case_id' => 'Case',
        'is_old_patient' => 'Old Patient',
        'doctor_id' => 'Doctor',
        'bed_type_id' => 'Ward Type',
        'bed_id' => 'Bed',
        ...
        'antenatal' => 'Antenatal Status',
        'new_antenatal' => 'New Antenatal',
        'case_id' => 'CASE ID',
        'maternity'=>'Maternity'
    ],
    ...
    'antenatal' => [
        ...
        'date' => 'Date',
        'condition' => 'Condition',
        'special_findings_and_remark' => 'Special Findings and Remark',
        'pelvic_examination' => 'Pelvic Examination',
        'sp' => 'SP',
        'uter_size' => 'Uter Size',
        'uterus_size' => 'Uterus Size',
        'presentation_position' => 'Presentation Position',
        'presenting_part_to_brim' => 'Presenting Part To Brim',
        'foetal_heart' => 'Foetal Heart',
        'blood_pressure' => 'Blood Pressure',
        'antenatal_oedema' => 'Antenatal Oedema',
        'urine_sugar' => 'Urine (Sugar)',
        'urine_albumin' => 'Urine Albumin',
        'antenatal_weight' => 'Antenatal Weight',
        'remark' => 'Remark',
        'next_visit' => 'Next Visit',
        'previous_antenatal_details' => 'Previous Antenatal Details',
    ],

    'postnatal' => [
        'title' => 'Postnatal',
        'patient_id' => 'Patient ID',
        'postnatal_history' => 'Postnatal History',
        'new_postnatal' => 'New Postnatal',
        'labour_time' => 'Labour Time',
        'delivery_time' => 'Delivery Time',
        'routine_question' => 'Routine Question',
        'general_remark' => 'General Remark',
    ],

    'previous_obstetric_history' => [
        'previous_obstetric_history' => 'Previous Obstetric History',
        'new_previous_obstetric_history' => 'Add Previous Obstetric History',
        'obstetric' => 'Obstetric History',
        'place_of_delivery' => 'Place of Delivery',
        'duration_of_pregnancy' => 'Duration of Pregnancy',
        'complications' => 'Complications in Pregnancy or Puerperium',
        'birth_weight' => 'Birth Weight',
        'gender' => 'Gender',
        'infant_feeding' => 'Infant Feeding',
        'birth_status' => 'Birth Status',
        'alive' => 'Alive',
        'dead' => 'Dead',
        'alive_or_dead_date' => 'Alive/Dead Date',
    ...
    'maternity_patient' => [
        'maternity_patient_out' => 'Maternity - Patient Out',
        'maternity_patient' => 'Maternity Patient',
        'maternity_patients' => 'Maternity Patients',
        'new_maternity_patient' => 'New Maternity Patient',
        'search_by' => 'Search Patient by',
        'edit_maternity_patient' => 'Edit Maternity Patient',
        'maternity_patient_details' => 'Maternity Patient Details',
        'maternity_number' => 'Maternity No',
    ...
    'new_change' => [
        'pathology_units' => 'Laboratory Units',
        'pathology_unit' => 'Laboratory Unit',
        'add_unit' => 'New Laboratory Unit',
        'edit_unit' => 'Edit Laboratory Unit',
        'pathology_unit_not_found' => 'Laboratory Unit not found',
        'pathology_unit_cant_deleted' => 'Laboratory Unit can\'t be deleted.',
        'pathology_parameter_not_found' => 'Laboratory Parameter not found',
        'pathology_parameter_cant_deleted' => 'Laboratory Parameter can\'t be deleted.',
        'pathology_parameter' => 'Laboratory Parameter',
        'pathology_parameters' => 'Laboratory Parameters',
        'add_parameter' => 'New Laboratory Parameter',
        'edit_parameter' => 'Edit Laboratory Parameter',
        ...
        'report_date_required' => 'Report Date field is required.',
        'parameter_name' => 'Parameter Name',
        'patient_result' => 'Patient Result',
        'select_parameter_name' => 'Select Parameter Name',
        'reference_range' => 'Reference Range',
        'select_unit' => 'Select Unit',
        'print_pathology_test' => 'Print Laboratory Test',
        'print_radiology_test' => 'Print Radiology Test',
        'view_pathology_test' => 'View Laboratory Test',
        'pathology_test_report' => 'Laboratory Test Report',
        'patient_report_value' => 'Patient Report Value',
    ],

    'patient_id_card' => [
        'id' => 'ID',
        'patient_id_card' => 'Smart Cards',
        'new_patient_id_card_template' => 'New Smart Card Template',
        'edit_patient_id_card_template' => 'Edit Smart Card Template',
        'patient_id_card_template' => 'Smart Patient Card Templates',
        'color' => 'Color',
        'patient_unique_id' => 'Patient Unique ID',
        'new_patient_id_card' => 'New Smart Card',
        'generate_patient_id_card' => 'Generate Smart Cards',
    ...
    'role-settings' => [
        ...
        'new_role' => 'New Role',
        'edit_role' => 'Edit Role',
        'operation_category_field_required' => 'Role field is required.',
    ],
    ...
    'permission-settings' => [
        ...
        'permission_field_required' => 'Permission field is required.',
    ],
];
