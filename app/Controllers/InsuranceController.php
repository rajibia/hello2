...
class InsuranceController extends AppBaseController
{
    ...
    {
        $isEdit = false;
        return view('insurances.create',compact('isEdit'));
    }
    ...
    public function show(Insurance $insurance)
    {
        ...
        $packages = $this->insuranceRepository->getInsurancePackage($insurance->id);

        return view('insurances.show', compact('packages', 'insurance'));
    }
    ...
    public function edit(Insurance $insurance)
    {
        ...
        return view('insurances.edit', compact('packages', 'insurance','isEdit'));
    }
