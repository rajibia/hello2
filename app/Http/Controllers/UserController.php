...
class UserController extends AppBaseController
{
    ...
    {
        $isEdit = false;
        $department = Department::orderBy('name')->pluck('name', 'id')->toArray();
		$role	=	Role::orderBy('name')->pluck('name', 'id')->toArray();
        $doctorDepartments = DoctorDepartment::pluck('title', 'id')->toArray();

        return view('users.create', compact('isEdit', 'role', 'doctorDepartments','department'));
    }
    ...
    public function edit(User $user)
    {
        ...
        return view('users.edit', compact('isEdit', 'user', 'role','department'));
    }
