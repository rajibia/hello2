...
class AccountsMedicineBillController extends AppBaseController
{
    ...
    {
        return view('accounts.medicine-bills.index');
    }
    ...
    public function create()
    {
        ...
        return view('accounts.medicine-bills.create',
    ...
    public function store(CreateMedicineBillRequest $request)
    {
        ...
        if (empty($input['medicine'])) {
            ...
            return Redirect::route('accounts.medicine-bills.create');
        }
        ...
        if ($input['category_id']) {
            ...
            return Redirect::route('accounts.medicine-bills.index');

        }
    }

    public function show(MedicineBill $accountsMedicineBill)
    {
        $medicineBill = $accountsMedicineBill;
        $medicineBill->load(['saleMedicine.medicine']);

        return view('accounts.medicine-bills.show', compact('medicineBill'));
    }

    public function edit(MedicineBill $accountsMedicineBill)
    {
        $medicineBill = $accountsMedicineBill;
        ...
        return view('accounts.medicine-bills.edit',
    ...
    public function update(MedicineBill $accountsMedicineBill, UpdateMedicineBillRequest $request)
    {
        $input = $request->all();
        ...
        // if ($input['payment_status'] == true && $input['paid_amount'] < $input['net_amount'] ) {

        //     return $this->sendError('Paid Amount should be greater than or equal to total net');
        // }
    ...
    public function destroy(MedicineBill $accountsMedicineBill)
    {
        $medicineBill = $accountsMedicineBill;
    ...
    public function convertToPDF($id)
    {
        ...
        // $pdf = PDF::loadView('accounts.medicine-bills.medicine_bill_pdf', compact('medicineBill', 'data'));

        // return $pdf->stream('accounts.medicine-bill.pdf');
        return view('accounts.medicine-bills.medicine_bill_pdf', compact('medicineBill', 'data'))->with('target', '_blank');
    }
