...
class EmployeePrescriptionsTable extends LivewireTableComponent
{
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make(__('messages.medicine_bills.payment_status'), 'medicineBill.payment_status')
                ->view('patients_prescription_list.templates.payment_status'),
            Column::make(__('messages.issue_status'), 'medicineBill.issue_status')
                ->view('patients_prescription_list.templates.issue_status'),
    ...
    public function builder(): Builder
    {
        ...
        $query = Prescription::whereHas('patient.patientUser')->whereHas('doctor.doctorUser')->with('patient.patientUser',
            'doctor.doctorUser', 'medicineBill')->select('prescriptions.*');
