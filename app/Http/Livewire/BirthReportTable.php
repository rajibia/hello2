    ...
    public function columns(): array
    {
        return [
            ...
            Column::make(__('messages.case.doctor'), 'doctor.doctorUser.first_name')
                ...
                ->searchable()
                ->sortable(),
            Column::make(__('messages.birth_report.child_name'), 'child_name')
                ->sortable(),
            Column::make(__('messages.birth_report.weight'), 'weight')
                ->sortable(),
            Column::make(__('messages.birth_report.child_gender'), 'gender')
                ->sortable(),
