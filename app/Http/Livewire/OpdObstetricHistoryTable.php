...
class OpdObstetricHistoryTable extends LivewireTableComponent
{
    protected $model = PreviousObstetricHistory::class;

    public $showButtonOnHeader = true;
    public $buttonComponent = 'opd_obstetric_history.add-button';
    ...
    public function configure(): void
    {
        ...
        $this->setConfigurableAreas([
            'toolbar-right-end' => [
                'opd_obstetric_history.add-button', [
                    'ipdId' => $this->ipdId,
                ],
            ],
        ]);
    ...
    public function columns(): array
    {
        return [
            Column::make(__('messages.antenatal.date'), 'created_at')
                ->view('opd_obstetric_history.columns.date')
                ->searchable()
                ->sortable(),
            ...
            Column::make(__('messages.common.action'), 'id')
                ->view('opd_obstetric_history.action'),
        ];
    }
