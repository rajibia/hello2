    ...
    public function columns(): array
    {
        return [
            ...
            Column::make(__('messages.insurance.insurance_code'), 'insurance_code')
                ->sortable()
                ->searchable(),
            Column::make('Claim Code Count', 'claim_code_count')
                    ->sortable()
                    ->searchable(),
            Column::make('Card type', 'card_type')
                    ->sortable()
                    ->searchable(),
            Column::make('Visit per month', 'visit_per_month')
                ->sortable()
                ->searchable(),
            Column::make('Serial # Count', 'card_serial_no_count')
                ->sortable()
                ->searchable(),
            Column::make('Membership # Count', 'membership_no_count')
                ->sortable()
                ->searchable(),                
            // Column::make('Other Identification', 'other_identification')
            //     ->sortable()
            //     ->searchable(),
