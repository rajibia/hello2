...
class DiagnosisCategoryTable extends LivewireTableComponent
{
    ...
    public function configure(): void
    {
        ...
        $this->setThAttributes(function (Column $column) {
            if ($column->isField('id')) {
                return [
                    'class' => 'w-5 ps-125 pe-5 text-center',
    ...
    {
        return [
            Column::make(__('messages.diagnosis_category.icd-10-code'), 'code')->sortable()->searchable(),
            Column::make(__('messages.diagnosis_category.diagnosis_category'), 'name')
                ->sortable()
                ->searchable(),
            Column::make(__('messages.diagnosis_category.description'), 'description')->sortable()->searchable(),
