...
class PatientPrescriptionDetailTable extends LivewireTableComponent
{
    public $showFilterOnHeader = true;

    public $showButtonOnHeader = true;

    public $buttonComponent = 'patients.patient_prescription_detail_column.add-button';
    ...
    public function configure(): void
    {
        ...
        $this->setConfigurableAreas([
            'toolbar-right-end' => [
                'patients.patient_prescription_detail_column.add-button', [
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make(__('messages.issue_status'), 'medicineBill.payment_status')
                ->view('patients_prescription_list.templates.payment_status'),
    ...
    public function builder(): Builder
    {
        ...
        $query = Prescription::with('patient.patientUser', 'doctor.doctorUser', 'medicineBill')->where('prescriptions.patient_id', $this->patientId)->select('prescriptions.*');
        ...
        if ($user->hasRole('Doctor')) {
            $query->where('prescriptions.doctor_id', $user->owner_id);
        }
        if ($user->hasRole('Patient')) {
            $query->where('prescriptions.patient_id', $user->owner_id);
        }
