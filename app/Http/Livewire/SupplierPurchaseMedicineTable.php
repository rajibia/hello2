...
class SupplierPurchaseMedicineTable extends LivewireTableComponent
{
    protected $model = [PurchaseMedicine::class, 'getSupplierPurchase'];
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make(__('messages.purchase_medicine.payment_status'), 'payment_status')
    ...
    {
        $query = PurchaseMedicine::where('supplier_id', $this->supplierId)->with('purchasedMedcines')
            ->select('purchase_medicines.*');
