...
class OpdPostnatalsTable extends LivewireTableComponent
{
    protected $model = PostnatalHistory::class;

    public $showButtonOnHeader = true;
    public $buttonComponent = 'opd_postnatal_history.add-button';
    ...
    public function configure(): void
    {
        ...
        $this->setConfigurableAreas([
            'toolbar-right-end' => [
                'opd_postnatal_history.add-button', [
                    'opdId' => $this->opdId,
                ],
            ],
        ]);
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make(__('messages.antenatal.date'), 'created_at')
                ->view('opd_postnatal_history.columns.date')
                ->searchable()
                ->sortable(),
            ...
            Column::make(__('messages.common.action'), 'id')
                ->view('opd_postnatal_history.action'),
        ];
    }
