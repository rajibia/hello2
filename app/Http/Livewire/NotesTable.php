...
class NotesTable extends LivewireTableComponent
{
    protected $model = Notes::class;

    // public $showButtonOnHeader = true;

    // public $buttonComponent = 'notes.add-button';
    ...
    public function configure(): void
    {
        $this->setPrimaryKey('id')
            ->setDefaultSort('notes.created_at', 'desc')
    ...
    {
        $query = Notes::whereHas('patient.patientUser')->with('patient.patientUser')->select('notes.*');
