...
/**
 * Class NursingProgressNoteRepository
 *
 * @version March 2, 2020, 4:38 am UTC
 */
class NursingProgressNoteRepository extends BaseRepository
{
    ...
    {
        return NursingProgressNote::class;
    }
    ...
    {
        try {
            $patient = NursingProgressNote::with('patient.patientUser')->where('patient_id', $input['patient_id'])->first();
