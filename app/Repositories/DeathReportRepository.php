   ...
   public function store($input)
    {
        try {
            ...
            // Create the death report with the provided data, including attachments
            $deathReport = DeathReport::create([
                'patient_id' => $input['patient_id'],
                'case_id' => $input['case_id'],
                'doctor_id' => $input['doctor_id'],
                'date' => $input['date'],
                'description' => $input['description'] ?? null,
                'attachments' => $input['attachments'] ?? null, // Handle attachments
                'cause_of_death' => $input['cause_of_death'] ?? null,
                'immediate_cause_of_death' => $input['immediate_cause_of_death'] ?? null,
                'location_of_death' => $input['location_of_death'] ?? null,
                'next_of_kin' => $input['next_of_kin'] ?? null,
                'next_of_kin_contact' => $input['next_of_kin_contact'] ?? null,
            ]);
