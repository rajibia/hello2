 ...
 */
class IpdProvisionalDiagnosis extends Model implements HasMedia
{
    use InteractsWithMedia;

    public const IPD_DIAGNOSIS_PATH = 'ipd_provisional_diagnosis';

    public $table = 'ipd_provisional_diagnoses';
    ...
    public static $rules = [
        ...
        // 'ipd_patient_department_id' => 'required|exists:ipd_patient_departments,id',
        // 'code' => 'required',
        // 'name' => 'required',
        // 'file' => 'nullable|mimes:jpeg,png,pdf,docx,doc',
    ];

    protected $appends = ['ipd_provisional_diagnosis_document_url'];
