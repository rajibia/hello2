...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('ipd_previous_obstetric_history')) {
            Schema::create('ipd_previous_obstetric_history', function (Blueprint $table) {
                $table->id();
    ...
    {
        Schema::dropIfExists('ipd_previous_obstetric_history');
    }
};
