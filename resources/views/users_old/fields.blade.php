...
<div class="row">
    ...
    @if (!$isEdit)
    	<div class="col-lg-6 mb-5">
            ...
            {{ Form::select('department_id', $department, null, ['class' => 'form-select fw-bold', 'required', 'id' => 'department_id', 'placeholder' => " Select Department", 'data-control' => 'select2']) }}
        </div>
        <div class="col-lg-6 mb-5">
            {{ Form::label('department_id', __('messages.employee_payroll.role') . ':', ['class' => 'form-label']) }}
            <span class="text-danger">*</span>
            {{ Form::select('role_id', $role, null, ['class' => 'form-select fw-bold', 'required', 'id' => 'userRole', 'placeholder' => __('messages.role.select_role'), 'data-control' => 'select2']) }}
        </div>
    @endif
    <div class="col-md-6">
