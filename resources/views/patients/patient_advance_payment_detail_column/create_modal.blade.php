            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::select('patient_id', $patients, $data->id ?? null, ['class' => 'form-select', (isset($data->id) ? 'disabled' : ''), 'id' => 'advancePaymentPatientId','placeholder' => __('messages.document.select_patient'), 'required','data-control' => 'select2']) }}
                    </div>
                    @if(isset($data->id))
