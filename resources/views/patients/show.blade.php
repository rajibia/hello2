...
@section('content')
    <div class="container-fluid">
        ...
        {{Form::hidden('prescriptionMedicineStoreUrl',route('prescription.medicine.store'),['id'=>'createMedicineFromPrescriptionPost'])}}
        <div class="d-flex flex-column">
            ...
            @include('patients.patient_advance_payment_detail_column.create_modal')
        </div>
    </div>
@endsection
