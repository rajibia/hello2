    ...
    <div class="col-md-2">
        <div class="mb-5">
            <div class="mb-5">
                ...
                {{ Form::hidden('patient_id', !empty($opdPatientDepartment->patient_id) ? $opdPatientDepartment->patient_id : '', ['class' => 'currencySymbol']) }}
                {{ Form::select('patient_id_select', $data['patients'], !empty($opdPatientDepartment->patient_id) ? $opdPatientDepartment->patient_id : '', ['class' => 'form-select', 'required', 'id' => 'editOpdPatientId', 'placeholder' => __('messages.document.select_patient'), 'data-control' => 'select2']) }}
            </div>
        </div>
    </div>
    <div class="col-md-2">
        <div class="mb-5">
            <div class="mb-5">
                ...
                {{ Form::hidden('patient_case_id', !empty($opdPatientDepartment->patientCase) ? $opdPatientDepartment->patientCase->case_id : 'patient_case_id', ['class' => 'patientCaseId']) }}
            </div>
        </div>
    </div>
    <div class="col-md-2">
    ...
    <div class="col-md-3">
        <div class="mb-5">
            <div class="mb-5">
                ...
                <span class="required"></span>
                {{ Form::select('doctor_id', $data['doctors'], null, ['class' => 'form-select', '', 'id' => 'editOpdDoctorId', 'placeholder' => __('messages.web_home.select_doctor'), 'data-control' => 'select2']) }}
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="mb-5">
            <div class="mb-5">
                ...
                <span class="required"></span>
                {{ Form::select('charge_id', $data['charges'], null, ['class' => 'form-select', 'required', 'id' => 'editOpdChargeId', 'placeholder' => __('messages.select_consultation_charge'), 'data-control' => 'select2']) }}
            </div>
        </div>
    </div>
    <div class="col-md-3">
