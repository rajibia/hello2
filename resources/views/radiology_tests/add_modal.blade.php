<div id="add_radiology_test_modal" class="modal fade" role="dialog" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        ...
        <div class="modal-content">
            ...
            {{ Form::open(['id' => 'addRadTestForm']) }}
            <div class="modal-body">
                <div class="alert alert-danger d-none hide" id="addRadiologyTestErrorsBox"></div>
                ...
                @elseif(isset($maternityPatient))
                    {{ Form::hidden('maternity_id', $maternityPatient->id) }}
                    {{ Form::hidden('patient_id', $maternityPatient->patient_id) }}
                @endif
                ...
                {{ Form::hidden('addradiologyTestUrl', route('radiology.test.store'), ['id' => 'addradiologyTestUrl']) }}
                {{ Form::hidden('radiology_test', __('messages.radiology_test.radiology_tests'), ['id' => 'radiologyTest']) }}
                {{ Form::hidden('uniqueId',4,['id'=>'parameterRadUniqueId'])}}
                {{ Form::hidden('associateParameters',json_encode($parameterRadList),['class'=>'associateRadParameters'])}}
                ...
                <div class="row">
                    ...
                    @if (isset($maternityPatient) && $maternityPatient->id != '')
                        <div class="form-group col-md-3 mb-5">
                            {{ Form::label('maternity_id', __('messages.maternity_patient.maternity_id') . ':', ['class' => 'form-label']) }}
                            {{-- <span class="required"></span> --}}
                            {{ Form::select('maternity_id', $maternitys, isset($maternityPatient) ? $maternityPatient->id : "", ['class' => 'form-select', ($maternityPatient->id != '' ? 'disabled' : ''), 'id' => 'vitalsMaternityId', 'placeholder' => __('messages.document.select_patient')]) }}
                            <input type="hidden" name="maternity_id" value="{{ isset($maternityPatient) ? $maternityPatient->id : "" }}">
                                ...
                                <div class="table-responsive-sm">
                                    <div class="overflow-auto">
                                        <table class="table table-striped">
                                            ...
                                            <tbody class="add-radiology-test-container">
                                                <tr>
                                                    <td>
                                                        ...
                                                        {{ Form::select('test_name[]', $radiologyTestTemplates, null, ['class' => 'form-select select2Selector radiology-parameter-data modal_radiology_test_name', '', 'required', 'id' => 'vitalsTestId', 'placeholder' => __('messages.radiology_test.select_test_name')]) }}
                                                    </td>
                                                    <td>
                                                        {{ Form::text('report_days[]', null, ['placeholder' => __('messages.radiology_test.report_days'),'class' => 'form-control', 'id' => 'report_days', 'readonly']) }}
                                                    </td>
                                                    <td>
                                                        {{ Form::date('report_date[]', null, ['placeholder' => __('messages.radiology_test.report_date'),'class' => 'form-control ', 'id' => 'report_date']) }}
                                                    </td>
                                                    <td>
                                                        {{ Form::text('amount[]', null, ['placeholder' => __('messages.radiology_test.amount'),'class' => 'form-control amount_summand', 'id' => 'amount', 'readonly']) }}
                                                    </td>
                                                    <td class="table__add-btn-heading text-center form-label fw-bolder text-gray-700 mb-3">
                                                        <a href="javascript:void(0)" type="button"
                                                            class="btn btn-primary text-star add-parameter-modal-radiology-test-billing">
                            ...
                            <div class="row ">
                                <div class="col-md-5">
                                    <div class="form-group mb-5">
                                        ...
                                        {{ Form::select('referral_doctor', $doctors, null, ['class' => 'form-select referral_doctor', '', 'required', 'id' => 'vitalsRadDoctorId', 'placeholder' => __('messages.radiology_test.referral_doctor')]) }}
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <div class="form-group mb-5">
                                        ...
                                        <span class="required"></span>
                                        {{ Form::text('doctor_name', null, ['class' => 'form-control','required', 'id' => 'doctor_rad_name', 'placeholder'=>__('messages.radiology_test.reference_name')]) }}
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="form-group mb-5">
                                        ...
                                        {{ Form::textarea('note', null, ['class' => 'form-control','placeholder'=>__('messages.radiology_test.note')]) }}
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="form-group mb-5">
                                        ...
                                        {{ Form::text('previous_report_value', null, ['class' => 'form-control','placeholder'=>__('messages.radiology_test.previous_report_value')]) }}
                                    </div>
                                </div>
                            </div>
                        </div>
                           ...
                           <table>
                                <tbody>
                                    <tr>
                                        ...
                                        <th style="text-align:right"><span id="sub_rad_total">0.00</span> {{getCurrencySymbol()}}</th>
                                    </tr>
                                        ...
                                        <th style="text-align:left">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    {{ Form::number('discount_percent', 0, ['class' => 'form-control', 'id' => 'discount_rad_input', 'placeholder'=>__('messages.radiology_test.discount_percent')]) }}
                                                </div>
                                            </div>
                                        </th>
                                        <th style="text-align:right"><span id="discount_rad">0.00</span> {{getCurrencySymbol()}}</th>
                                        <input type="hidden" name="discount_value" value="" id="discount_rad_hidden">
                                    </tr>
                                    <tr>
                                        <th colspan="2" style="text-align:left">{{ __('messages.invoice.total') }}:</th>
                                        <th style="text-align:right"><span id="total_rad">0.00</span> {{getCurrencySymbol()}}</th>
                                        <input type="hidden" name="total" value="" id="total_rad_hidden">
                                    </tr>
                                </tbody>
                           </table>
                        </div>
