<div class="row g-3">
    ...
    <div class="row">
        ...
        @if ($maternity_id != '')
            <div class="col-md-6">
                <label class="form-label fw-semibold">{{ __('messages.maternity_patient.maternity_id') }}</label>
                {{ Form::select('maternity_id', $maternitys, $maternity_id ?? null, ['class' => 'form-select', ($maternity_id != '' ? 'disabled' : ''), 'id' => 'vitalsMaternityId', 'placeholder' => __('messages.document.select_patient')]) }}
        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <button type="button" class="btn btn-success btn-sm add-parameter-radiology-test-billing">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-sm mb-0">
                                <thead class="table-light">
                                    <tr>
                                        <th style="width: 30%">Test Name <span class="text-danger">*</span></th>
                                    ...
                                    <tr>
                                        <td colspan="5" class="text-muted small bg-light">
                                            <i class="fas fa-info-circle me-1"></i>At least one test is required. You can add more tests using the "Add Test" button.
                                        </td>
                                </tr>
                            </thead>
                            <tbody class="radiology-test-container">
                                <tr>
                                    <td>
                                            {{ Form::select('template_id[]', $templatesForSelect, null, ['class' => 'form-select template-select', 'required', 'id' => 'template_id_1', 'placeholder' => __('messages.radiology_test.select_test_name')]) }}
                                            <input type="hidden" name="form_configuration[]" class="form-config" value="">
                                    </td>
                                    <td>
                                            {{ Form::text('report_days[]', null, ['placeholder' => __('messages.radiology_test.report_days'), 'class' => 'form-control report-days', 'id' => 'report_days_1', 'readonly']) }}
                                    </td>
                                    <td>
                                            {{ Form::date('report_date[]', date('Y-m-d'), ['placeholder' => __('messages.radiology_test.report_date'), 'class' => 'form-control report-date', 'id' => 'report_date_1', 'required', 'min' => date('Y-m-d')]) }}
                                    </td>
                                    <td>
                                            {{ Form::text('amount[]', null, ['placeholder' => __('messages.radiology_test.amount'), 'class' => 'form-control amount', 'id' => 'amount_1', 'readonly']) }}
                                    </td>
