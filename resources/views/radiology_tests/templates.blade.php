<div class="container">
    <h2 class="text-center">Radiology Tests Templates</h2>
    <table class="table table-bordered table-striped">
        ...
        <tbody>
            @if($radiologyTestTemplates->isEmpty())
                <tr>
                    <td colspan="11" class="text-center">No Radiology Tests Found</td>
                </tr>
            @else
                @foreach($radiologyTestTemplates as $test)
                    <tr>
