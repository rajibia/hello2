        ...
        <div class="row gx-10 mb-5">
            ...
            <div class="col-lg-6 col-sm-12">
                <div class="mb-5">
                    ...
                    <span class="required"></span>
                    {{ Form::select('status', $statusArr, isset($invoice) ? $invoice->status : null, ['placeholder' => __('messages.common.status'),'class' => 'form-select status', 'id' => 'status', 'required', 'data-control' => 'select2']) }}
                </div>
            </div>
        </div>
                ...
                <tbody class="invoice-item-container">
                        ...
                        @foreach ($invoice->invoiceItems as $invoiceItem)
                            <tr class="border-bottom">
                                ...
                                <td class="table__item-desc">
                                    {{ Form::select('charge_id[]', $charges, $invoiceItem->charge_id, ['class' => 'form-select chargeId', 'required', 'placeholder' => __('messages.common.choose') . ' ' . __('messages.charges'), 'data-control' => 'select2']) }}
                    ...
                    @else
                        <tr class="border-bottom border-bottom-dashed">
                            ...
                            <td class="table__item-desc">
                                {{ Form::select('charge_id[]', $charges, null, ['class' => 'form-select chargeId ', 'required', 'placeholder' => __('messages.common.choose') . ' ' . __('messages.charges'), 'data-control' => 'select2']) }}
                            </td>
                            <td>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 end justify-content-end">
                <table class="table table-responsive-sm table-row-dashed g-5 gs-0 mb-0  text-gray-700 mr-3">
                    <tbody>
                        ...
                        <tr class="text-start text-muted  fs-7 text-uppercase gs-0 payment-change-tr" @if(isset($invoice))  @else style="display:none;" @endif>
