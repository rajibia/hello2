                ...
                <div>
                    <div class="card-body  border-top p-9">
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-4 d-flex flex-column">
                                <label class="fw-bold text-muted py-3">{{ __('messages.radiology_test.unit')  }}</label>
                                <span class="fw-bolder fs-6 text-gray-800">{{ (!empty($radiologyTest->unit)) ? $radiologyTest->unit : __('messages.common.n/a') }}</span>
                            </div>
                            <div class="col-lg-4 d-flex flex-column">
                            ...
                            <div class="col-lg-4 d-flex flex-column">
                                <label class="fw-bold text-muted py-3">{{ __('messages.radiology_test.method')  }}</label>
                                <span class="fw-bolder fs-6 text-gray-800">{{ (!empty($radiologyTest->method)) ? $radiologyTest->method : __('messages.common.n/a') }}</span>
                            </div>
                            <div class="col-lg-4 d-flex flex-column">
                                <label class="fw-bold text-muted py-3">{{ __('messages.radiology_test.report_days')  }}</label>
                                <span class="fw-bolder fs-6 text-gray-800">{!! (!empty($radiologyTest->report_days)) ? nl2br(e($radiologyTest->report_days)) : __('messages.common.n/a') !!}</span>
                            </div>
                            <div class="col-lg-4 d-flex flex-column">
                        ...
                        <div class="px-30 table-responsive">
                            <table class="table table-stripped">
                                ...
                                <tbody>
                                    @if (empty($radiologyParameterItems))
                                        {{ __('messages.common.n/a') }}
                                    @else
                                        @foreach ($radiologyParameterItems as $radiologyParameterItem)
                                            <tr>
                                                <td class="py-4 border-bottom-0">{{  $radiologyParameterItem->radiologyParameter->parameter_name }}</td>
                                                <td class="py-4 border-bottom-0">
                                                    {{ $radiologyParameterItem->patient_result }}
                                                </td>
                                                <td class="py-4 border-bottom-0">{{ $radiologyParameterItem->radiologyParameter->reference_range }}
                                                </td>
                                                <td class="py-4 border-bottom-0">
