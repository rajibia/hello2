...
<head>
    ...
    <title>{{ __('messages.new_change.radiology_test_report') }}</title>
        ...
        <table>
            <tbody>
                <tr style="color:#2c3e50;">
                    ...
                    <td class="px-30">
                        <h3 class="mb-0 lh-1">
                            {{ __('messages.new_change.radiology_test_report') }}
                        </h3>
                        ...
                        <div class="col-md-4 co-12 mt-md-0 mt-5">
                            <table class="table w-100">
                                ...
                                <tr class="">
                                    <td class="">
                                        <label for="name"
                                            class="pb-2 fs-5 text-gray-600 me-1">{{ __('messages.radiology_test.method') }}:
                                        </label>
                                    </td>
                                    <td class="text-end fs-5 text-gray-800">
                    ...
                    color:#2c3e50;">
                        <table class="table w-100">
                            ...
                            {{-- <tr class="">
                                <td class="">
                                    <label for="name"
                                        class="pb-2 fs-5 text-gray-600 me-1">{{ __('messages.radiology_test.unit') }}:
                                    </label>
                                </td>
                                <td class="text-end fs-5 text-gray-800">
                                    {{ $data['radiologyTest']->radiologyunit->name }}
                                </td>
                            </tr> --}}
                            <tr class="">
                                <td class="">
