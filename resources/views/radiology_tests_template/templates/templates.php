<script id="radiologyParameterTemplate" type="text/x-jsrender">
    <tr>
    <td class="table__item-desc">
            <select class="form-select radiology-parameter-data select2Selector" name="parameter_id[]" data-id="{{:uniqueId}}" required>
        ...
        <td>
            <input class="form-control" required="" value='' name="unit_id[]" id="unitId" type="text" readonly placeholder="<?php echo  __('messages.radiology_test.unit'); ?>">
        </td>
