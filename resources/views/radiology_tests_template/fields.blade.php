<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group mb-5">
            ...
            <span class="required"></span>
            {{ Form::select('charge_category_id',$data['chargeCategories'], null, ['class' => 'form-select rChargeCategories','required','id' => 'radiologyChargeCategories','placeholder'=>__('messages.radiology_category.select_charge_category'),'required']) }}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group mb-5">
            ...
            {{ Form::text('standard_charge', null, ['placeholder' => __('messages.radiology_test.standard_charge'),'class' => 'form-control price-input radiologyStandardCharge', 'id' => 'rTestStandardCharge', 'readonly', 'required']) }}
        </div>
    </div>
