<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group mb-5">
            {{ Form::label('unit', __('messages.radiology_test.unit') . ':', ['class' => 'form-label']) }}
            {{ Form::number('unit', null, ['class' => 'form-control', 'placeholder' => __('messages.radiology_test.unit')]) }}
        </div>
    </div> --}}
    <div class="col-md-3">
        <div class="form-group mb-5">
    ...
    <div class="col-md-3">
        <div class="form-group mb-5">
            {{ Form::label('method', __('messages.radiology_test.method') . ':', ['class' => 'form-label']) }}
            {{ Form::text('method', null, ['class' => 'form-control', 'placeholder' => __('messages.radiology_test.method')]) }}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group mb-5">
    ...
    <div class="col-md-3">
        <div class="form-group mb-5">
            ...
            <span class="required"></span>
            {{ Form::select('charge_category_id', $data['chargeCategories'], null, ['class' => 'form-select rChargeCategories', 'required', 'id' => 'editRadiologyChargeCategories', 'placeholder' => __('messages.radiology_category.select_charge_category'), 'required']) }}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group mb-5">
            ...
            {{ Form::text('standard_charge', null, ['placeholder' => __('messages.radiology_test.standard_charge'), 'class' => 'form-control price-input radiologyStandardCharge', 'id' => 'editRTestStandardCharge', 'readonly', 'required']) }}
        </div>
    </div>
                    ...
                    <table class="table table-striped">
                        <thead class="thead-dark">
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="">{{ __('messages.radiology_test.unit') }}<span
                                        class="required"></span>
                                </th>
                                <th class="table__add-btn-heading text-center form-label fw-bolder text-gray-700 mb-3">
                                    <a href="javascript:void(0)" type="button"
                                        class="btn btn-primary text-star add-radiology-parameter-test">
                        ...
                        <tbody class="radiology-test-container">
                            @if (isset($radiologyParameterItems))
                                @foreach ($radiologyParameterItems as $key => $radiologyParameterItem)
                                    <tr>
                                        <td>
                                            {{ Form::select('parameter_id[]', $data['radiologyParameters'], isset($radiologyParameterItem->radiologyParameter) ? $radiologyParameterItem->radiologyParameter->id : null, ['class' => 'form-select  select2Selector radiology-parameter-data', 'required', 'placeholder' => __('messages.new_change.select_parameter_name'), 'data-id' => '1', 'data-control' => 'select2']) }}
                                        </td>
                                        {{-- <td>
                                            {{ Form::text('patient_result[]', $radiologyParameterItem->patient_result ?? null, ['placeholder' => __('messages.new_change.patient_result'), 'class' => 'form-control ', 'data-id' => 1, 'required']) }}
                                        </td> --}}
                                        <td>
                                            {{ Form::text('reference_range[]', $radiologyParameterItem->radiologyParameter->reference_range ?? null, ['placeholder' => __('messages.new_change.reference_range'), 'class' => 'form-control', 'id' => 'rangeId', 'readonly']) }}
                                        </td>
                                        <td>
                                            {{ Form::text('unit_id[]', $radiologyParameterItem->radiologyParameter->radiologyUnit->name ?? null, ['placeholder' => __('messages.radiology_test.unit'), 'class' => 'form-control', 'id' => 'unitId', 'readonly']) }}
                                        </td>
                                        @if ($key != 0)
                                ...
                                @endforeach
                            @endif
                            @if ($radiologyParameterItems->count() == false)
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        {{ Form::text('unit_id[]', null, ['placeholder' => __('messages.radiology_test.unit'), 'class' => 'form-control', 'id' => 'unitId', 'readonly']) }}
                                    </td>
                                </tr>
                            @endif
                        </tbody>
    ...
    <div class="col-md-12">
        <div class="d-flex justify-content-end">
            ...
            <a href="{{ route('radiology.test.template.index') }}"
