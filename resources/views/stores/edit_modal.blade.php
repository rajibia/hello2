    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h3>{{ __('messages.store.edit_store') }}</h3>
            ...
            <div class="modal-body">
                ...
                {{ Form::hidden('storeId', null, ['id' => 'storeId']) }}
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        {{ Form::label('edit_name', __('messages.common.name').':', ['class' => 'form-label required']) }}
                        {{ Form::text('name', null, ['id'=>'edit_name','class' => 'form-control','required','placeholder' => __('messages.common.name')]) }}
                    </div>
                </div>
            </div>
