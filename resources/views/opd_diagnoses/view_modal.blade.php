<div id="show_opd_diagnosis_modal" class="modal fade" role="dialog" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12 mb-3">
                        <h3> Report Type </h3>
                        <p id="opdDiagnosisReportTypeView"></p>
                    </div>
                    <div class="col-md-12 mb-3">
                        <h3> Report Date </h3>
                        <p id="opdDiagnosisReportDateView"></p>
                    </div>
                    <div class="col-md-12 mb-3">
                        <h3> Description </h3>
