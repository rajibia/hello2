                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-12 mb-5">
                        <div class="form-group">
                            ...
                            {{ Form::text('code', null, ['placeholder' => __('messages.ipd_patient_diagnosis.code'),'class' => 'form-control', 'rows' => 4, 'readOnly', 'id' => 'editOpdDiagnosisCode']) }}
                        </div>
                    </div>
                    <div class="form-group col-md-12 mb-5">
                        <div class="form-group">
                            {{ Form::label('name', __('messages.ipd_patient_diagnosis.name'),['class' => 'form-label']) }}
                            {{ Form::text('name', null, ['placeholder' => __('messages.ipd_patient_diagnosis.name'),'class' => 'form-control', 'rows' => 4, 'readOnly', 'id' => 'editOpdDiagnosisName']) }}
                        </div>
                    </div>
                    <div class="form-group col-md-12 mb-5">
