<div class="row">
    ...
    <div class="col-lg-4 col-md-4 col-sm-12">
        <div class="form-group mb-5">
            {!! Form::label('issued_by_id', __('messages.issued_item.issued_by') . ':', ['class' => 'form-label']) !!}
            <span class="required"></span>
            {{ Form::select('issued_by_id', [null], null, ['id' => 'issuedBy', 'class' => 'form-select', 'required', 'data-control' => 'select2', 'placeholder' => __('messages.message.select_user')]) }}
        </div>
    </div>
    <div class="col-lg-4 col-md-4 col-sm-12">
        <div class="form-group mb-5">
