<div class="row">
    <div class="col-sm-12">
        <div class="form-group mb-5">
            {{ Form::label('supplier', __('messages.supplier.select_supplier').':', ['class' => 'form-label']) }}
            {{ Form::select('supplier_id', $suppliers, null, ['class' => 'form-select purchaseMedicineSupplierId', 'placeholder' => __('messages.supplier.select_supplier'), 'id' => 'medicineSupplierId', 'data-control' => 'select2', 'required']) }}
        </div>
    </div>
    <div class="col-sm-12">
                ...
                <table class="table table-striped" id="prescriptionMedicalTbl">
                    ...
                    <tbody class="prescription-medicine-container">
                        <tr>
                            ...
                            <td>
                                {{ Form::number('lot_no[]', null, ['class' => 'form-control', 'id' => 'lot_no1', 'placeholder' => __('messages.purchase_medicine.lot_no')]) }}
                            </td>
                            <td>
                            ...
                            <td>
                                {{ Form::number('sale_price[]', '0.00', ['class' => 'form-control prescriptionMedicineMealId', 'id' => 'sale_price1', 'required']) }}
                            </td>
                            <td>
                                {{ Form::number('purchase_price[]', '0.00', ['class' => 'form-control purchase-price', 'rows' => 1, 'id' => 'purchase_price1', 'required']) }}
                            </td>
                            <td>
