<div>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="mb-0">
            <i class="fas fa-plus-circle me-2"></i>{{ __('Create Dynamic Radiology Template') }}
        </h4>
        <a href="{{ route('radiology.test.template.index') }}" class="btn btn-secondary">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <select class="form-select" wire:model.live="charge_category_id">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" wire:model="icon_class" placeholder="fas fa-x-ray">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            <label class="form-label fw-semibold">{{ __('Icon Color') }}</label>
                            <input type="color" class="form-control form-control-color" wire:model="icon_color">
                            <small class="text-muted">{{ __('Color for the template icon') }}</small>
                        </div>
                    </div>
                </div>
            </div>
...
function editGroupName(index, currentName) {
    ...
    if (newName && newName.trim() !== '') {
        Livewire.find(document.querySelector('[wire\\:id]').getAttribute('wire:id')).call('editGroup', index, newName.trim());
    }
}

function handleFieldTypeChange(fieldIndex, fieldType) {
    // This function can be used for any field type specific logic
    console.log('Field type changed:', fieldIndex, fieldType);
}
</script>
