    ...
    <div class="pagination-container">
        ...
        <nav aria-label="Page navigation">
            <ul class="pagination">
                ...
                @else
                    <li class="page-item">
                        <button class="page-link prev" wire:click="previousPage" rel="prev" aria-label="@lang('pagination.previous')">
                            <i class="fa-solid fa-chevron-left"></i>
                        </button>
                    </li>
                @endif
                ...
                @if ($paginator->hasMorePages())
                    <li class="page-item">
                        <button class="page-link next" wire:click="nextPage" rel="next" aria-label="@lang('pagination.next')">
