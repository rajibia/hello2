<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group mb-5">
            ...
            <span class="required"></span>
            {{ Form::select('unit_id', $units, null, ['class' => 'form-select', 'required', 'id' => 'editItemUnit', 'data-control' => 'select2', 'placeholder' => __('messages.common.choose') . ' ' . __('messages.item.unit')]) }}
        </div>
    </div>
    <div class="col-md-12">
        <div class="form-group mb-5">
