@extends('layouts.app')
@section('title')
    {{ __('messages.medicine.expiry_medicine_report') }}
@endsection
@section('page_css')
    ...
    <div class="container-fluid">
        <div class="d-flex flex-column">
            <div class="d-flex justify-content-between align-items-center mb-5">
                <h1>{{ __('messages.medicine.expiry_medicine_report') }}</h1>
    ...
    $(document).ready(function() {
        $('#printReport').click(function() {
            ...
            try {
                ...
                const visibleTable = document.querySelector('#expiryMedicineReportTable .table-responsive table');
                if (visibleTable) {
                ...
                printWindow.document.write(`
                    ...
                    <html>
                    <head>
                        <title>Expiry Medicine Report</title>
                        <style>
                                body { 
                    ...
                    <body>
                        ...
                        <div id="print-content">
                            ${tableFound ? tableHTML : `<p>No medicine records found</p>`}
                        </div>
