...
<script>
    $(document).ready(function() {
        $('#printMedicineAdjustmentReport').click(function() {
            ...
            try {
                ...
                const visibleTable = document.querySelector('#medicineAdjustmentReportTable .table-responsive table');
                if (visibleTable) {
                ...
                printWindow.document.write(`
                    ...
                    <html>
                    <head>
                        <title>Medicine Adjustment Report</title>
                        <style>
                                body { 
                    ...
                    <body>
                        ...
                        <div id="print-content">
                            ${tableFound ? tableHTML : `<p>No medicine adjustment records found</p>`}
                        </div>
