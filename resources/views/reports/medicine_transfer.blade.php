...
@section('title', __('messages.medicine.medicine_transfer_report'))
...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-5 flex-wrap gap-3">
        <h1 class="mb-0">{{ __('messages.medicine.medicine_transfer_report') }}</h1>
    ...
    <div class="mb-5">
        ...
        <input type="text" id="liveSearch" class="form-control form-control-lg"
               placeholder="Search by medicine, from/to warehouse, date..." autofocus>
    </div>

    <div class="card shadow-sm">
        <div class="card-body">
            <div id="transferReportWrapper">
...
<script>
const initMedicineTransferExports = function () {
    ReportExporter.initializeOnWrapper('#transferReportWrapper', {
        excludeColumns: [],
        reportTitle: 'Medicine Transfer Report',
        fileName: 'medicine_transfer_report'
    });

    ReportExporter.initializePrint('printReport', '#transferReportWrapper table', 'Medicine Transfer Report');
};

// Try immediately
initMedicineTransferExports();

// Also on DOMContentLoaded
document.addEventListener('DOMContentLoaded', initMedicineTransferExports);

// Re-init on Livewire events
window.addEventListener('livewire:load', initMedicineTransferExports);
window.addEventListener('livewire:update', initMedicineTransferExports);
window.addEventListener('livewire:updated', initMedicineTransferExports);
</script>
@endsection