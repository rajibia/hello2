<div id="add_general_examination_modal" class="modal fade" role="dialog" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            {{ Form::open(['id' => 'addGeneralExaminationForm']) }}
            <div class="modal-body">
                <div class="alert alert-danger d-none hide" id="addGeneralExaminationErrorsBox"></div>
                ...
                <div class="row gx-10 mb-5">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="mb-5">
                            <div class="mb-5">
                                {{ Form::label('general_examination', 'General Examination:', ['class' => 'form-label']) }}
                                {{ Form::textarea('general_examination', null, ['class' => 'form-control', 'rows' => 3, 'tabindex' => '2', 'placeholder' => 'General Examination']) }}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-end">
                    {{ Form::button(__('messages.common.save'), ['type'=>'submit','class' => 'btn btn-primary me-3','id'=>'btnGeneralExaminationSave','data-loading-text'=>"<span class='spinner-border spinner-border-sm'></span> Processing..."]) }}
