    ...
    <div class="col-lg-3 col-md-6 col-sm-12">
        <div class="mb-5">
            <div class="mb-5">
                ...
                {{ Form::number('height', null, ['class' => 'form-control ipdDepartmentFloatNumber', 'required', 'max' => '100', 'step' => '.01', 'tabindex' => '2', 'placeholder' => __('messages.ipd_patient.height')]) }}
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-md-6 col-sm-12">
        <div class="mb-5">
            <div class="mb-5">
                ...
                {{ Form::number('weight', null, ['placeholder' => __('messages.ipd_patient.weight'), 'class' => 'form-control ipdDepartmentFloatNumber', 'required', 'data-mask' => '##0,00', 'max' => '200', 'step' => '.01', 'tabindex' => '3']) }}
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-md-6 col-sm-12">
