				...
				<tbody class="invoice-item-container">
					@if (isset($invoice))
						...
						@endphp
							<tr class="border-bottom">
								...
								<td class="text-center">
									{{ Form::text('price[]', number_format($invoiceItem->price), ['class' => 'form-control price-input price', 'required', 'placeholder' => __('messages.invoice.price'), 'readonly' => 'readonly']) }}
								</td>
					...
					@else
						<tr class="border-bottom border-bottom-dashed">
							...
							<td>
								{{ Form::text('price[]', null, ['placeholder' => __('messages.invoice.price'), 'class' => 'form-control price-input price', 'required', 'readonly' => 'readonly']) }}
							</td>
