<div class="row gx-10 mb-5">
    ...
    <div class="form-group col-md-3 mb-5">
        ...
        {{ Form::select('patient_id', $patients, $patient_id ?? null, ['class' => 'form-select', ($patient_id != '' ? 'disabled' : ''), 'required', 'id' => 'prescriptionPatientId', 'placeholder' => __('messages.document.select_patient')]) }}
    </div>
    @if($patient_id != '')
