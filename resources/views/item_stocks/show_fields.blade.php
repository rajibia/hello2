<div>
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="stockOverview" role="tabpanel">
                ...
                <div>
                    <div class="card-body  border-top p-9">
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-2 d-flex flex-column">
                                {{ Form::label('supplier_id', __('messages.item_stock.supplier_name').(':'), ['class' => 'fw-bold text-muted py-3']) }}
                                <span class="fw-bolder fs-6 text-gray-800">{{ !empty($itemStock->supplier) ? $itemStock->supplier->name : __('messages.common.n/a')}}</span>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-2 d-flex flex-column">
                                {{ Form::label('store_id', __('messages.item_stock.store_name').(':'), ['class' => 'fw-bold text-muted py-3']) }}
                                <span class="fw-bolder fs-6 text-gray-800">{{ !empty($itemStock->store) ? $itemStock->store->name : __('messages.common.n/a')}}</span>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-2 d-flex flex-column">
                                {{ Form::label('quality', __('messages.item_stock.quantity').(':'), ['class' => 'fw-bold text-muted py-3']) }}
                                <p class="m-0">
                                    <span class="badge bg-light-success fs-6">{{ $itemStock->quantity}}</span></p>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-2 d-flex flex-column">
