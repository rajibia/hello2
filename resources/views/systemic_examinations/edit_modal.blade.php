<div id="edit_systemic_examination_modal" class="modal fade" role="dialog" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            {{ Form::open(['id' => 'editSystemicExaminationForm']) }}
            <div class="modal-body">
                <div class="alert alert-danger d-none hide" id="editSystemicExaminationErrorsBox"></div>
               
                {{ Form::hidden('systemic_examination_id', null, ['id' => 'editSystemicExaminationId']) }}
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    {{ Form::text('lungs_description', null, ['class' => 'form-control', 'placeholder' => 'Description', 'id' => 'edit_lungs_description_systemic']) }}
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ Form::text('cardio_description', null, ['class' => 'form-control', 'placeholder' => 'Description', 'id' => 'edit_cardio_description_systemic']) }}
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ Form::text('abdomen_description', null, ['class' => 'form-control', 'placeholder' => 'Description', 'id' => 'edit_abdomen_description_systemic']) }}
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ Form::text('ear_description', null, ['class' => 'form-control', 'placeholder' => 'Description', 'id' => 'edit_ear_description_systemic']) }}
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ Form::text('nose_description', null, ['class' => 'form-control', 'placeholder' => 'Description', 'id' => 'edit_nose_description_systemic']) }}
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ Form::text('throat_description', null, ['class' => 'form-control', 'placeholder' => 'Description', 'id' => 'edit_throat_description_systemic']) }}
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ Form::text('musco_description', null, ['class' => 'form-control', 'placeholder' => 'Description', 'id' => 'edit_muscos_description_systemic']) }}
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ Form::text('nervous_description', null, ['class' => 'form-control', 'placeholder' => 'Description', 'id' => 'edit_nervous_description_systemic']) }}
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ Form::text('skin_description', null, ['class' => 'form-control', 'placeholder' => 'Description', 'id' => 'edit_skin_description_systemic']) }}
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ Form::text('eye_description', null, ['class' => 'form-control', 'placeholder' => 'Description', 'id' => 'edit_eye_description_systemic']) }}
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="row gx-10 mb-5">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="mb-5">
                            <div class="mb-5">
                                {{ Form::label('systemic_examination', 'Systemic Examination Comment:', ['class' => 'form-label']) }}
                                {{ Form::textarea('systemic_examination', null, ['class' => 'form-control', 'rows' => 3, 'tabindex' => '2', 'placeholder' => 'Systemic Examination Comment', 'id' => 'editSystemicExaminationValue']) }}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-end">
                    {{ Form::button(__('messages.common.save'), ['type'=>'submit','class' => 'btn btn-primary me-3','id'=>'btnEditSystemicExaminationSave','data-loading-text'=>"<span class='spinner-border spinner-border-sm'></span> Processing..."]) }}
