<div id="add_nursing_note_modal" class="modal fade" role="dialog" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            {{ Form::open(['id' => 'addNursingNoteForm']) }}
            <div class="modal-body">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="mb-5">
                            <div class="mb-5">
                                ...
                                {{ Form::textarea('notes', null, ['class' => 'form-control', 'required', 'rows' => 3, 'tabindex' => '2', 'placeholder' => 'Nursing Progress Notes']) }}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-end">
                    {{ Form::button(__('messages.common.save'), ['type'=>'submit','class' => 'btn btn-primary me-3','id'=>'btnNursingNoteSave','data-loading-text'=>"<span class='spinner-border spinner-border-sm'></span> Processing..."]) }}
