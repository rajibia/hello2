        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group mb-5">
                    {{ Form::label('name', __('messages.package.procedure').' Name:', ['class' => 'form-label']) }}
                    <span class="required"></span>
                    {{ Form::text('name', null, ['class' => 'form-control ','required','placeholder'=>__('messages.package.procedure')]) }}
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group mb-5">
                    {{ Form::label('tariff', __('messages.procedure.rate').' / Insurance Tariff:', ['class' => 'form-label']) }}
                    <span class="required"></span>
            ...
            <div class="form-group col-sm-6 mb-5">
                ...
                <div class="form-check form-switch">
                    <input class="form-check-input w-35px h-20px is-active" name="status" type="checkbox"
                           value="1" {{(!isset($procedure)) ? 'checked':(($procedure->status) ? 'checked' : '')}}>
                </div>
            </div>
           
            <div class="d-flex justify-content-end">
                {{ Form::submit(__('messages.common.save'), ['class' => 'btn btn-primary me-2', 'id' => 'procedureBtnSave']) }}
