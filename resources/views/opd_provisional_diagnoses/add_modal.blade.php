<!-- Modal -->
<div id="add_opd_provisional_diagnosis_modal" class="modal fade" role="dialog" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            {{ Form::open(['url' => route('opd.procedural.diagnosis.store'), 'method' => 'POST', 'id' => 'addProvisionalOpdDiagnosisForm']) }}
            ...
            <div class="modal-footer p-0">
                {{ Form::button('Save', ['type'=>'submit','class' => 'btn btn-primary me-3','id'=>'opdDiagnosisSave','data-loading-text'=>"<span class='spinner-border spinner-border-sm'></span> Processing..."]) }}
