@extends('layouts.app')
@section('title')
    Company Pathology Test Details
@endsection
        ...
        <div class="d-flex flex-column">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <div>
                                <h4 class="mb-0">Company Pathology Test Details</h4>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-6">
                    <div class="card h-100">
                        <div class="card-header">
                            <h6 class="mb-0 fw-semibold">Pathology Test Information</h6>
                        </div>
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-6">
            ...
            <!-- Pathology Test Items -->
            @if($bill->pathologyTestItems && $bill->pathologyTestItems->count() > 0)
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h6 class="mb-0 fw-semibold">Pathology Test Items</h6>
                        </div>
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table table-striped mb-0">
                                    ...
                                    <tbody>
                                        @foreach($bill->pathologyTestItems as $item)
                                        <tr>
                                            <td>{{ $item->pathologytesttemplate->test_name ?? 'N/A' }}</td>
                                            <td>{{ $item->pathologytesttemplate->short_name ?? 'N/A' }}</td>
                                            <td>{{ $item->pathologytesttemplate->report_days ?? 'N/A' }}</td>
