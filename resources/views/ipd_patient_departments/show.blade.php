...
@section('content')
    ...
    {{Form::hidden('ipdPostnatalUrl',route('ipd.postnatal.index'),['id'=>'showIpdPostnatalUrl'])}}
    ...
    {{ Form::hidden('IpdAntenatalUrl', url('antenatals'), ['class' => 'IpdAntenatalUrl']) }}
    ...
    <div class="container-fluid">
        <div class="d-flex flex-column">
            ...
            @include('ipd_diagnoses.view_modal')
             @include('ipd_provisional_diagnoses.add_modal')
            @include('ipd_provisional_diagnoses.edit_modal')
            @include('ipd_provisional_diagnoses.view_modal')
            ...
            @include('ipd_charges.edit_modal')
             @include('ipd_postnatal_history.edit_modal')
