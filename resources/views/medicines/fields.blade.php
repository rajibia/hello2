...
<div class="form-group col-md-6 mb-5">
    ...
    {{--    <span--}}
    {{--        class="required"></span>--}}
    {{ Form::text('salt_composition', null, ['class' => 'form-control','placeholder'=>__('messages.medicine.salt_composition')]) }}
</div>
...
<div class="form-group col-md-6 mb-5">
    ...
    <span class="required"></span>
    {{ Form::date('expiry_date', isset($medicine) ? $medicine->expiry_date : null, ['class' => 'form-control expiry-date-input','required','placeholder'=>'Expiry Date']) }}
</div>
