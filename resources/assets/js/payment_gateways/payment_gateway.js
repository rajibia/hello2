...
listenSubmit("#UserCredentialsSettings", function (e) {
    ...
    if (StripeCheckbox && $("#stripeKey").val().trim() == "") {
        displayErrorMessage(Lang.get("messages.stripe_key") +" "+ Lang.get("messages.common.field_required"));
        return false;
    }
    if (StripeCheckbox && $("#stripeSecret").val().trim() == "") {
        displayErrorMessage(Lang.get("messages.stripe_secret") +" "+ Lang.get("messages.common.field_required"));
        return false;
    }
    // if (PaypalCheckbox && $("#paypalKey").val().trim() == "") {
    //     displayErrorMessage(Lang.get("messages.paypal_client_id") +" "+ Lang.get("messages.common.field_required"));
    //     return false;
    // }
    // if (PaypalCheckbox && $("#paypalSecret").val().trim() == "") {
    //     displayErrorMessage(Lang.get("messages.paypal_secret") +" "+ Lang.get("messages.common.field_required"));
    //     return false;
    // }
    // if (PaypalCheckbox && $("#paypalMode").val().trim() == "") {
    //     displayErrorMessage(Lang.get("messages.paypal_mode") +" "+ Lang.get("messages.common.field_required"));
    //     return false;
    // }
    if (razorpayCheckbox && $("#razorpayKey").val().trim() == "") {
        displayErrorMessage(Lang.get("messages.razorpay_key") +" "+ Lang.get("messages.common.field_required"));
        return false;
    }
    if (razorpayCheckbox && $("#razorpaySecret").val().trim() == "") {
        displayErrorMessage(Lang.get("messages.razorpay_secret") +" "+ Lang.get("messages.common.field_required"));
        return false;
    }
